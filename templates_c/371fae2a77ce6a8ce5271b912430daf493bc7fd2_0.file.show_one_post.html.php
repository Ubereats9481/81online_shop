...
.webp" alt="商品圖片" class="img-thumbnail"><!--put a picture-->
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 class="show_one_price"><strong id="price"><?php echo $_smarty_tpl->tpl_vars['product']->value['Price'];?>
</strong></h4>
            <div class="butp">
                <h3>數量:<h3>
            ...
            <br>
            <span style="font-size: 24;">總價格:</span>    <span id="total_price" style="font-size: 24;"><?php echo $_smarty_tpl->tpl_vars['product']->value['Price'];?>
</span>
            <div class="col-sm-20">
                <strong>
                    <h3>內容簡介:</h3>
