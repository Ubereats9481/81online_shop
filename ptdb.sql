...
CREATE TABLE IF NOT EXISTS `post` (
  `post_number` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `post_title` varchar(255) NOT NULL,
  `post_content` mediumtext NOT NULL,
  `post_hot` mediumint UNSIGNED NOT NULL,
  `post_time` datetime NOT NULL,
  `post_hide` tinyint(1) NOT NULL,
  PRIMARY KEY (`post_number`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COMMENT='for practice';
...
(1, 'test', '<p><span style=\"font-size:72px\">早安</span></p>\r\n', 29, '2020-02-04 17:33:25', 0),
(2, 'that is a test', '<p>這是隻兔兔</p>\r\n', 77, '2020-02-04 16:55:32', 2),
(3, '123312323', '<p>qwrewrqr</p>\r\n', 14, '2020-02-04 16:55:20', 2),
(4, 'fuffufudus', '<p>asfdsafadsf</p>\r\n', 7, '2020-02-04 16:47:13', 2),
(6, 'ghkytufkymkf', '<p>drfgjlksdflkjrfbvjkortjnbvklijrtbvxvdzxcv</p>\r\n', 1, '2023-05-21 05:02:36', 1),
(7, 'ghkytufkymkf', '<p>drfgjlksdflkjrfbvjkortjnbvklijrtbvxvdzxcv</p>\r\n', 1, '2023-05-21 05:04:59', 1),
(8, 'dfghertydfgjcvbn', '<p>werhrwhrtyh</p>\r\n', 1, '2023-05-21 05:05:17', 1);
...
(32, '歡樂節慶點心', '王景茹', 182, '60道健康美味，16個節日文化典故。\r\n陪您一整年節慶，凝聚全家人情感！\r\n\r\n\r\n　　傳統文化中有許多節日與慶典，都帶著豐富的相關典故與食俗。本書收錄最完整的16個中西節日糕點，包含中式三大節慶：春節、端午節、中秋節，尚有元宵節、清明節、七夕情人節，甚至有暖心豐收的立冬、冬至、臘八節。再加上現今中西文化融合，許多西洋的節日，例如：西洋情人節、白色情人節、復活節、萬聖節、感恩節、聖誕節受到人們的喜愛，以及表達對父母撫育之情的父親節、母親節。透過色香味俱全的美食，不僅可以讓您大飽口福，享受做點心的樂趣外，更能凝聚一家人歡樂的氣氛，讓生活充滿笑聲與樂趣！', '9789865813215', 'discount', 330, 1, 321),
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb3 COMMENT='for user';

--
-- 傾印資料表的資料 `user`
--

INSERT INTO `user` (`user_number`, `user_id`, `user_pw`, `Rank`, `email`, `phone`, `birth`, `age`) VALUES
(1, 'ubereats', '$2y$10$wF/0.PwAAa.QPGZt7zR8DOQ9Jz102Fi8WW9btEsNX/6dpqqOGUVGK', 1, '', '', '2010-01-10', NULL),
(11, 'aaa', '$2y$10$AfvJNS5lbzN/tBs6DzwnWeT.ZnuRIBao9AtmHRMIr18BGC3RAc8Ti', 1, 'abc@gmail.com', '', '2020-10-10', NULL),
(10, '54321', '$2y$10$UCzMe.9Wo8fgSnj2xccg4.nPttY.zsgXvUvF6PEq62Bgm8IV/size', 1, NULL, NULL, NULL, NULL),
(9, '12345', '$2y$10$I/JuoRhIj5lNaJATVftrb.TNib.UDspz6fZ5JUMb7rqFYrGYPAeOa', 1, NULL, NULL, NULL, NULL);
COMMIT;
