...
function content_6472f336b661f8_32549998 (Smarty_Internal_Template $_smarty_tpl) {
?><a id="re" hidden></a>
...
"><?php echo $_smarty_tpl->tpl_vars['product']->value['Name'];?>
                    ...
                    <div class="row">
                        <div class="col-sm-6 price" style="color: red; font-size: 20px;">特價: <?php echo $_smarty_tpl->tpl_vars['product']->value['Price'];?>
</div>
                        <div class="col-sm-6" style="text-align: right; margin-top: 5px;">剩餘數量: <?php echo $_smarty_tpl->tpl_vars['product']->value['Remaining'];?>
</div>
                    </div>
                </div>
            </div>
